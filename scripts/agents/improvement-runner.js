...
class AgentRunner {
    constructor(taskId) {
        ...
        this.taskFolder = path.join(projectRoot, this.config.config.tasks.folder, taskId);
    }
    ...
    async gatherReferences() {
        ...
        const inspoFolder = path.join(projectRoot, this.config.config.inspiration.folder);
